            ...
            <nav className="flex justify-between items-center">
                ...
                <div className="flex items-center md:gap-16 gap-4">
                    ...
                    <div className="relative sm:w-72 w-40 space-x-2">
                        ...
                        <input type="text" placeholder="what are you looking for ?" className="bg-[#EAEAEA] py-1 md:px-8 px-6 rounded-md w-full focus:outline-none"/>
                    </div>
                </div>
                    ...
                    <div>
                        {
                            ...
                            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}> 
                                <img src={avatarImg} alt="User icon" className={`size-7 rounded-full ${ currentUser ? 'ring-2 ring-blue-500' : '' }`}/>
                            </button>
                            </> :
